...
public class CarRollBackMover : ICarMovementStrategy
{
    ...
    public CarRollBackMover(Transform transform, BoxCollider self, int direction)
    {
    ...
    public event System.Action<CarRollBackMover> Stopped;
