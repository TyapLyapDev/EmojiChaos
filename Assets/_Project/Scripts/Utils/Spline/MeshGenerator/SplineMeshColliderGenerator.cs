...
namespace EmojiChaos.Utils.Splines.MeshGenerator
{
    ...
    public class SplineMeshColliderGenerator : MonoBehaviour
    {
        ...
        private void AddConnectionFaces(List<int> triangles, int prevBase, int currBase)
        {
            int[][] faces = new[]
            {
                new[] { prevBase + 0, currBase + 0, currBase + 2, prevBase + 2 },
                new[] { prevBase + 1, prevBase + 3, currBase + 3, currBase + 1 },
                new[] { prevBase + 2, currBase + 2, currBase + 3, prevBase + 3 },
                new[] { prevBase + 0, prevBase + 1, currBase + 1, currBase + 0 },
                new[] { prevBase + 0, prevBase + 2, prevBase + 3, prevBase + 1 },
                new[] { currBase + 0, currBase + 1, currBase + 3, currBase + 2 },
            };
